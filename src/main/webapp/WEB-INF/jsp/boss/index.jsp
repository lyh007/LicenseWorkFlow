...
<table border="1" width="100%">
    ...
    <tr>
        ...
        <td>
            <s:if test="showAudit">
                <a href="boss/boss!preAudit.action?issue.id=<s:property value="id"/>&taskId=<s:property value="issueTask.id"/>">审批</a>
            </s:if>
            <s:else>
                <a href="boss/boss!view.action?issue.id=<s:property value="id"/>">查看</a>
            </s:else>
        </td>
        </s:iterator>
        </s:if>
